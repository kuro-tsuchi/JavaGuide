...
- [1. Java 内存区域详解](#1-java-内存区域详解)
  - [1.1. 概述](#11-概述)
  - [1.2. 运行时数据区域](#12-运行时数据区域)
    - [1.2.1. 程序计数器](#121-程序计数器)
    - [1.2.2. Java 虚拟机栈](#122-java-虚拟机栈)
    - [1.2.3. 本地方法栈](#123-本地方法栈)
    - [1.2.4. 堆](#124-堆)
    - [1.2.5. 2.5 方法区](#125-25-方法区)
      - [1.2.5.1. 2.5.1 方法区和永久代的关系](#1251-251-方法区和永久代的关系)
      - [1.2.5.2. 2.5.2 常用参数](#1252-252-常用参数)
      - [1.2.5.3. 2.5.3 为什么要将永久代 (PermGen) 替换为元空间 (MetaSpace) 呢?](#1253-253-为什么要将永久代-permgen-替换为元空间-metaspace-呢)
    - [1.2.6. 2.6 运行时常量池](#126-26-运行时常量池)
    - [1.2.7. 直接内存](#127-直接内存)
  - [1.3. HotSpot 虚拟机对象探秘](#13-hotspot-虚拟机对象探秘)
    - [1.3.1. 对象的创建](#131-对象的创建)
      - [1.3.1.1. Step1:类加载检查](#1311-step1类加载检查)
      - [1.3.1.2. Step2:分配内存](#1312-step2分配内存)
      - [1.3.1.3. Step3:初始化零值](#1313-step3初始化零值)
      - [1.3.1.4. Step4:设置对象头](#1314-step4设置对象头)
      - [1.3.1.5. Step5:执行 init 方法](#1315-step5执行-init-方法)
    - [1.3.2. 对象的内存布局](#132-对象的内存布局)
    - [1.3.3. 对象的访问定位](#133-对象的访问定位)
  - [1.4. 重点补充内容](#14-重点补充内容)
    - [1.4.1. String 类和常量池](#141-string-类和常量池)
    - [1.4.2. String s1 = new String("abc");这句话创建了几个字符串对象？](#142-string-s1--new-stringabc这句话创建了几个字符串对象)
    - [1.4.3. 8种基本类型的包装类和常量池](#143-8种基本类型的包装类和常量池)
...
#### 1.2.5.3. 2.5.3 为什么要将永久代 (PermGen) 替换为元空间 (MetaSpace) 呢?
