...
- [1. 类文件结构](#1-类文件结构)
  - [1.1. 概述](#11-概述)
  - [1.2. 二 Class 文件结构总结](#12-二-class-文件结构总结)
    - [1.2.1. 2.1 魔数](#121-21-魔数)
    - [1.2.2. 2.2 Class 文件版本](#122-22-class-文件版本)
    - [1.2.3. 2.3 常量池](#123-23-常量池)
    - [1.2.4. 2.4 访问标志](#124-24-访问标志)
    - [1.2.5. 2.5 当前类索引,父类索引与接口索引集合](#125-25-当前类索引父类索引与接口索引集合)
    - [1.2.6. 2.6 字段表集合](#126-26-字段表集合)
    - [1.2.7. 2.7 方法表集合](#127-27-方法表集合)
    - [1.2.8. 2.8 属性表集合](#128-28-属性表集合)
  - [1.3. 参考](#13-参考)
